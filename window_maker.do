...
*tostring sdnn, gen(string_label) format(%10.0f) force
...
egen heartrate_window_3 = group(window_3_str),
*egen sdnn_window_3 = group(window_3_str),
drop window_3_str 
...
egen heartrate_window_5 = group(window_5_str),
*egen sdnn_window_5 = group(window_5_str),
drop window_5_str 
...
egen heartrate_window_10 = group(window_10_str)
*egen sdnn_window_10 = group(window_10_str)
drop window_10_str 
