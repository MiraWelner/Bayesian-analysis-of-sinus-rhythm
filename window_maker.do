...
egen window_3_sdnn = group(window_3_str),
drop window_3_str 
...
egen window_5_sdnn = group(window_5_str),
drop window_5_str 
...
*egen window_10_heartrate = group(window_10_str)
egen window_10_sdnn = group(window_10_str)
drop window_10_str 
