...
replace ss=3 if (thisepochisduringorclosesttoslee == 1) & (timefromepochbegin_tosleeponset_ == 0)
...
replace ss=5 if (timefromepochbegin_tosleeponset_ > 0) & (final_woken == 0) & (awake==1)
